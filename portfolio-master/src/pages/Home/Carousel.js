            ...
            <div className="container_wrapper">
                <div className="container">
                    <Slider {...settings}>
                        ...
                        <div className="no-left">
                            <a>醉白池（Zuibai Pool）是江南著名的古典园林之一，是上海的旅游胜地。从这座园林的前身算起，已有九百余年历史。醉白池历经300余年，仍保存有堂，轩，亭，舫，榭等古建筑，并保持着明清江南园林风貌。园林布局以一泓池水为中心，环池三面皆为曲廊亭榭，晴雨均可凭栏赏景。园内古木葱笼，亭台密布，古迹甚多，有四面厅、乐天轩、疑肪、雪海堂、宝成楼、池上草堂等亭台楼阁及邦彦画像石刻、《赤壁赋》真迹石刻、《难得糊涂》石刻等艺术瑰宝，还有树龄在三四百年的古银杏、古樟树，年龄在百年以上的牡丹。醉白池是上海地区五大古典园林中最古老的园林。
                            </a>
                            <img src={img88} alt=""/>
                        </div>
                        {/*<div>*/}
